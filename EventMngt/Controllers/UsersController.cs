...
namespace EventMngt.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            ViewBag.EventId = (int)Session["myid"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,UserName,UserOrganization,UserDesignation")] Users users)
        {
            if (ModelState.IsValid)
            {
